...
export default {
    ...
    methods: {
        ...
        getDPOSInfo() {
            DPOSInfo({ address: this.dposAddress, chainid: localStorage.getItem('chainID') }).then(res => {
        ...
        getDelegateDetails() {
            listDelegateDetails({ dposAddress: this.dposAddress, chainid: localStorage.getItem('chainID') }).then(res => {
