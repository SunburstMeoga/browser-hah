<template>
    <div>
        ...
        <div data-v-520cdd27="" class="content-child">
            <h1 class="h1">{{ $t('Pending.h1') }}</h1>
                    ...
                    <div data-v-603f4bbb="">
                        ...
                        <div data-v-603f4bbb="" class="pending_list pc btc">
                            ...
                            <ul data-v-603f4bbb="" class="item content" v-for="(item, index) in TxListDatas" :key="index">
                                ...
                                <li data-v-603f4bbb="" class="inner_item time"><span data-v-603f4bbb="" class="el-tooltip"
                                        aria-describedby="el-tooltip-9935" tabindex="0">{{ timeformat(item.transtime)
                                        }}</span></li>
                                <li data-v-603f4bbb="" class="inner_item fee">{{ item.amount }}</li>
                                <!--                                    <li data-v-603f4bbb="" class="inner_item fee">{{ item.free }}</li>-->
                                <li data-v-603f4bbb="" class="inner_item from"><!----><span data-v-603f4bbb="">{{ item.from
                                }}</span>
                                    <!---->
                                </li>
                                <li data-v-603f4bbb="" class="inner_item to"><!----><span data-v-603f4bbb="">{{ item.to
                                }}</span>
                                    <!---->
                                </li>
                            </ul>
                        ...
                        <div data-v-603f4bbb="" class="mobileList"><!---->
                            <ul data-v-603f4bbb="" class="items" v-for="(item, index) in TxListDatas" :key="index">
                                <div data-v-603f4bbb="" class="item">
                                    ...
                                    <div data-v-603f4bbb="" class="value"><a data-v-603f4bbb="" href="/tx" rel="nofollow">{{
                                        item.txid }}</a>
                                    </div>
                                </div>
                                <div data-v-603f4bbb="" class="item">
                                    ...
                                    <div data-v-603f4bbb="" class="value"><span data-v-603f4bbb="" class="el-tooltip"
                                            aria-describedby="el-tooltip-6781" tabindex="0">{{ timeformat(item.transtime)
                                            }}</span></div>
                                </div>
                                <div data-v-603f4bbb="" class="item">
                                ...
                                <div data-v-603f4bbb="" class="item">
                                    ...
                                    <div data-v-603f4bbb="" class="value"><!----><span data-v-603f4bbb="">{{ item.from
                                    }}</span>
                                        <!---->
                                    </div>
                                </div>
