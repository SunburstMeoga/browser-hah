...
<div class="text-sm pt-2 px-4 sm:pt-5 text-lightitemtitle dark:text-btndisable">
    ...
    <div class="flex justify-start items-center mb-2 sm:mb-4">
        ...
        <div class="cursor-pointer icon iconfont icon-copy text-clickable" @click="copyContent($store.state.blockInfo.hash)" />
    </div>
    ...
    <div class="flex justify-start items-center mb-2 sm:mb-4">
        ...
        <div class="flex justify-start items-center">
            <div @click="toAddress(blockInfo.reward_address)" class="hidden sm:block text-sm cursor-pointer text-clickable transition duration-300 ease-in-out transform hover:-translate-y-0.5 ">
            ...
            <div class="cursor-pointer icon iconfont icon-copy text-clickable pl-2" @click="copyContent(blockInfo.reward_address)" />
        </div>
    </div>
